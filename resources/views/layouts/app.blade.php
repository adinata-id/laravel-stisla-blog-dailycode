...
<head>
    ...
    <title>Dailycode.id - Stisla Admin Templates Gratis</title>
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            ...
                            <div class="dropdown-list-content">
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <img alt="image" src="{{ asset('stisla/dist/assets/img/avatar/avatar-2.png') }}"
                                        class="rounded-circle dropdown-item-img">
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <img alt="image" src="{{ asset('stisla/dist/assets/img/avatar/avatar-3.png') }}"
                                        class="rounded-circle dropdown-item-img">
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <img alt="image" src="{{ asset('stisla/dist/assets/img/avatar/avatar-4.png') }}"
                                        class="rounded-circle dropdown-item-img">
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <img alt="image" src="{{ asset('stisla/dist/assets/img/avatar/avatar-5.png') }}"
                                        class="rounded-circle dropdown-item-img">
                                    <div class="dropdown-item-desc">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <img alt="image" src="{{ asset('stisla/dist/assets/img/avatar/avatar-1.png') }}" width="30"
